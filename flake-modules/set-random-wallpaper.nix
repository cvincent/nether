    ...
    let
      ...
      set-random-wallpaper = (
        pkgs.writeShellScriptBin "set-random-wallpaper" ''
          ...
          top_wallpaper=$(find ${homeDirectory}/dotfiles/resources/wallpapers/nord-* -type f | sort -R | head -n1)
          ${wallpapers.swww.package}/bin/swww img -o DP-2 $top_wallpaper

          landscape_wallpaper=$(find ${homeDirectory}/dotfiles/resources/wallpapers/landscapes/nord-*-m0\.* -type f | sort -R | head -n1)
