        ...
        programs.qutebrowser = {
          ...
          keyBindings = {
            normal = {
              ...
              "<space>fV" =
                "hint links spawn yt-dlp -P home:~/videos/youtube/ -P temp:~/videos/youtube/.tmp/ -o '%(duration)s - %(title)s.%(ext)s' --embed-chapters --proxy http://192.168.1.114:8888 {hint-url}";
              "yv" =
                "spawn mpv --force-window=immediate --no-terminal --keep-open=yes --http-proxy='https://192.168.1.114:8888' {url}";
              "yV" =
                "spawn yt-dlp -P home:~/videos/youtube/ -P temp:~/videos/youtube/.tmp/ -o '%(duration)s - %(title)s.%(ext)s' --embed-chapters --proxy http://192.168.1.114:8888 {url}";
